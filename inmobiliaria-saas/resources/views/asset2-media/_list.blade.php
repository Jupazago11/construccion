...
>
    <div class="flex items-center justify-between gap-4">
        ...
        <p class="text-sm text-stone-500">{{ $asset2->media->count() }} archivos</p>
    </div>

    <div class="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        @forelse ($asset2->media as $media)
            @php
                $previewUrl = route('assets2.media.preview', [$asset2, $media]);
                    ...
                    <div class="flex items-center justify-between gap-2">
                        ...
                        @can('delete', $media)
                            <button
                                type="button"
                                data-action="delete"
                                data-url="{{ route('assets2.media.destroy', [$asset2, $media]) }}"
