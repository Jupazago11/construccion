@php
    $expenseFormSelected = [
        ...
        'is_activity' => (bool) $expense->activity_id,
        ...
        <div class="grid gap-6 md:grid-cols-3">
            ...
            <div>
                ...
                <label class="mt-1 inline-flex w-full items-center gap-3 rounded-2xl border border-stone-200 px-4 py-3 text-sm text-stone-700">
                    <input type="checkbox" name="is_activity" value="1" data-transaction-is-activity class="rounded border-stone-300 text-stone-900 shadow-sm focus:ring-stone-900" @checked($expense->activity_id)>
