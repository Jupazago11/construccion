        ...
        <div class="overflow-x-auto rounded-2xl border border-stone-200" data-invoice-items-x-scroll>
            <table class="min-w-full divide-y divide-stone-200 whitespace-nowrap text-sm">
                ...
                <tbody class="divide-y divide-stone-100">
                        ...
                        <tr data-row-id="{{ $item->id }}">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-end gap-2">
                                    <button type="button" data-action="edit" data-url="{{ $isPurchase ? route('purchases.edit', $item) : route('expenses.edit', $item) }}" data-title="Editar ítem" class="rounded-2xl border border-stone-200 p-2 text-stone-600 transition hover:bg-stone-100 hover:text-stone-900" title="Editar">
                                    ...
                                    <button type="button" data-action="delete" data-url="{{ $isPurchase ? route('purchases.destroy', $item) : route('expenses.destroy', $item) }}" data-confirm-message="¿Archivar este ítem?" class="rounded-2xl border border-rose-200 p-2 text-rose-700 transition hover:bg-rose-50" title="Archivar">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M8.257 3.099c.366-.446.911-.699 1.486-.699h.514c.575 0 1.12.253 1.486.699L12.85 4H16a1 1 0 110 2h-1l-.867 10.142A2 2 0 0112.14 18H7.86a2 2 0 01-1.993-1.858L5 6H4a1 1 0 010-2h3.15l1.107-.901zM8 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm4-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clip-rule="evenodd" /></svg>
                                    </button>
                                </div>
                            </td>
                    ...
                    @empty
                        <tr><td colspan="7" class="px-4 py-8 text-center text-stone-500">Sin ítems registrados.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
