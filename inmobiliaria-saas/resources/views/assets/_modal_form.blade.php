            ...
            <div>
                ...
                <div class="mt-1 flex items-center gap-2">
                    <select
                        ...
                        required
                    >
                        <option value="" x-text="activeTypes.length === 0 ? 'No hay tipos activos' : 'Selecciona un tipo'"></option>
                ...
                <div class="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
                    ...
                    <div class="rounded-2xl border border-stone-200 bg-stone-50 p-4">
                        <div class="grid gap-3">
                            <div>
                                <x-input-label for="{{ $formUid }}-asset-type-name" :value="'Tipo'" />
                                <x-text-input
                                    id="{{ $formUid }}-asset-type-name"
