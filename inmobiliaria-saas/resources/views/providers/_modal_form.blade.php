...
>
            ...
            >
                <div class="flex max-h-[88vh] w-full max-w-2xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl" x-on:click.stop>
                    ...
                    <div class="min-h-0 flex-1 space-y-4 overflow-y-auto p-5">
                        <div x-show="managerLoading" class="rounded-2xl border border-dashed border-stone-300 bg-stone-50 px-4 py-10 text-center text-sm font-medium text-stone-500">
                            Cargando tipos...
                        </div>
                        ...
                        <div x-show="! managerLoading" class="space-y-4">
                            <div class="rounded-2xl border border-stone-200 bg-stone-50 p-4">
                                <div>
                                    <x-input-label for="{{ $formUid }}-provider-type-name" :value="'Tipo'" />
                                    <x-text-input
                                        id="{{ $formUid }}-provider-type-name"
                                        type="text"
    ...
    <div class="sticky bottom-0 z-10 mt-auto shrink-0 border-t border-stone-200 bg-white px-1 pb-[calc(env(safe-area-inset-bottom)+0.5rem)] pt-4 shadow-[0_-8px_18px_rgba(255,255,255,0.92)]">
        ...
        <button type="submit" class="app-create-text-button">
